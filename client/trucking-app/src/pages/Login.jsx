...
//           <button
//             type="submit"
//             className="bg-green-950 p-2 text-white cursor-pointer w-full rounded-md hover:bg-green-800 transition"
//           >
//             Sign In
//           </button>
//         </form>
...
//           <Link to="/register" className="text-green-800 font-bold">
//             Register
//           </Link>
//         </h3>
//       </div>
