...
//   return (
// 	  <div className="flex flex-col items-center justify-center p-4 md:p-8 bg-sky-950 h-auto md:min-h-[450px] lg:w-[100vw]">
// 		  <div>
// 			  <img src={OurTeam} alt="" />
// 		  </div>
...
const Testimonial = () => {
	...
	return (
		<div
			className="relative flex flex-col items-center justify-center p-4 md:p-8 h-auto md:min-h-[450px] lg:w-[100vw]"
			style={{
			...
			>
			  <div className="px-3">
				...
				<div className="flex items-center justify-center mt-6 mb-6 md:mt-8 md:mb-8">
					<div
						onClick={goToPrevious}
						className="text-red-600 cursor-pointer bg-white rounded-full p-2 mr-4 hover:bg-gray-200 transition z-10">
						<KeyboardBackspaceOutlinedIcon />
					</div>
					<div
						onClick={goToNext}
						className="cursor-pointer text-white bg-red-600 rounded-full p-2 hover:bg-red-700 transition z-10">
						<EastOutlinedIcon />
					</div>
				</div>
			</div>
