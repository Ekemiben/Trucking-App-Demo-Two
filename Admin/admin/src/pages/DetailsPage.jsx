              ...
              <div className="flex ml-7 justify-between w-[70%] mb-8">
				...
				{/* <div className="flex flex-col lg:flex-row w-full justify-around gap-4">
					<div className="flex flex-col border-2 rounded-3xl shadow-md w-full lg:w-auto">
						...
						<div className="lg:min-w-[450px] px-7 pb-7">
							<div className="flex flex-col sm:flex-row justify-between mb-4 gap-2">
								<p className="text-gray-700 font-semibold min-w-[120px]">
									Full Name:
								</p>
								<p className="text-gray-500 break-words flex-1">
					...
					<div className="flex flex-col border-2 rounded-3xl shadow-md w-full lg:w-auto">
						...
						<div className="lg:min-w-[450px] px-7 pb-7">
							...
							<div className="flex flex-col sm:flex-row justify-between gap-2">
								...
								{application.resume ? (
									<p
										className="text-red-500 hover:cursor-pointer break-words flex-1"
										onClick={handleViewPdf}>
										View/Download
									</p>
								) : (
